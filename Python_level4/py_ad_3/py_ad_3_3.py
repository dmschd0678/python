"""
Section 3
Concurency, CPU Bound vs I/O Bound - Multiprocessing vs Threading, AsyncIO
...
CPU Bound vs I/O Bound
    ...
    - CPU성능 지표가 수행시간 단축으로 크게 영향을 끼치지 않음
    
메모리 바운딩, 캐시 바운딩

작업 목적에 따라 적절한 동시성 라이브러리 선택이 중요

최종 비교

- Multiprocessing : Multiple processes, 고가용성(CPU) Utilzation -> CPU-Bound -> 10개 부엌, 10명의 요리사, 10개 요리
