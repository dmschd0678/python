"""
Section 3
Concurency, CPU Bound vs I/O Bound - Blocking vs Non-Blocking IO
...
Blocking IO vs Non-blocking IO
    ...
    blocking IO
        ...
        - 제어권(IO 작업) -> 커널 소유 -> 응답(Response)전까지 대기(Block) -> 다른 작업 수행 불가(대기)
...
이해가 안 될 때 : https://limdongjin.github.io/concepts/blocking-non-blocking-io.html
"""